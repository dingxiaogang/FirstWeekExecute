...
public class RvStoryListAdapter extends RecyclerView.Adapter {
    private Context context;
    private ArrayList<StoryListBean.DataBean.DatasBean> datasBeans;

    public RvStoryListAdapter(Context context, ArrayList<StoryListBean.DataBean.DatasBean> datasBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_story_list, viewGroup, false);
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        public ListViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.story_rv_image);
            title = itemView.findViewById(R.id.story_rv_title);
            author = itemView.findViewById(R.id.story_rv_author);
            niceDate = itemView.findViewById(R.id.story_rv_niceDate);
        }
    }
}
